...
import { idlFactory } from './nimbus_ai.did.js';
export { idlFactory } from './nimbus_ai.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NIMBUS_AI;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nimbus_ai.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nimbus_ai canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nimbus_ai.did.js")._SERVICE>}
 */
export const nimbus_ai = createActor(canisterId);
