...
import { idlFactory } from './nimbus_marketplace.did.js';
export { idlFactory } from './nimbus_marketplace.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NIMBUS_MARKETPLACE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nimbus_marketplace.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nimbus_marketplace canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nimbus_marketplace.did.js")._SERVICE>}
 */
export const nimbus_marketplace = createActor(canisterId);
